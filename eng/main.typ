...
#let sidebarSection = {[
  ...
  #par[
    ...
    Junior *software engineer* with a confident grasp of *backend* and *system design*, now seeking opportunities to excel in the realms of solution architecture.

    Open to role *backend Go developer*.
  ]
