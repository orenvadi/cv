...
#let sidebarSection = {[
  ...
  Junior *Разработчик* с уверенным пониманием *бэкенда* и *проектирования систем*, сейчас в поисках возможности поработать в Backend сфере.

  Открыт на роль *Go бэкенд-разработчик*.
  ]
